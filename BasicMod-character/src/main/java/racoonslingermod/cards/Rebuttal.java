...
public class Rebuttal extends BaseCard {
    public static final String ID = makeID(racoonslingermod.cards.Rebuttal.class.getSimpleName());
    ...
    @Override
    public AbstractCard makeCopy() {return new Rebuttal();}
