...
public class MyCharacter extends CustomPlayer {
    ...
    public static final int ORB_SLOTS = 6;
...
//        retVal.add(FrontierJustice.ID);
//        retVal.add(QuickStrike.ID);
//        retVal.add(Desperado.ID);
//        retVal.add(Bullseye.ID);
