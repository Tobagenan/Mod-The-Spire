...
public class HawkEye extends BaseCard {
    public static final String ID = makeID(racoonslingermod.cards.HawkEye.class.getSimpleName());
    ...
    @Override
    public AbstractCard makeCopy() {return new HawkEye();}
